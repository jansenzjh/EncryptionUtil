...
@property (nonatomic, copy) void (^ _Nullable animating)(CGFloat);
/// Alias to <code>animating</code>
@property (nonatomic, copy) void (^ _Nullable progress)(CGFloat);
@end


@interface CALayer (SWIFT_EXTENSION(Macaw))
...
///
- (void)addAnimation:(CAAnimation * _Nonnull)anim forKey:(NSString * _Nullable)key withCompletion:(void (^ _Nullable)(BOOL))completion;
@end
...
@interface MacawView : UIView <UIGestureRecognizerDelegate>
...
@interface NSTimer (SWIFT_EXTENSION(Macaw))
@end


@interface UIImage (SWIFT_EXTENSION(Macaw))
@end
