...
SWIFT_CLASS("_TtC14SwiftyStoreKit24InAppProductQueryRequest")
@interface InAppProductQueryRequest : NSObject <SKProductsRequestDelegate>
- (void)start;
- (void)cancel;
...
SWIFT_CLASS("_TtC14SwiftyStoreKit26InAppReceiptRefreshRequest")
@interface InAppReceiptRefreshRequest : NSObject <SKRequestDelegate>
@property (nonatomic, readonly, strong) SKReceiptRefreshRequest * _Nonnull refreshReceiptRequest;
- (void)start;
- (void)requestDidFinish:(SKRequest * _Nonnull)request;
- (void)request:(SKRequest * _Nonnull)request didFailWithError:(NSError * _Nonnull)error;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC14SwiftyStoreKit23InAppReceiptVerificator")
@interface InAppReceiptVerificator : NSObject
@property (nonatomic, readonly, copy) NSURL * _Nullable appStoreReceiptURL;
- (nonnull instancetype)initWithAppStoreReceiptURL:(NSURL * _Nullable)appStoreReceiptURL OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSData * _Nullable appStoreReceiptData;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
@end
...
@interface SKProduct (SWIFT_EXTENSION(SwiftyStoreKit))
