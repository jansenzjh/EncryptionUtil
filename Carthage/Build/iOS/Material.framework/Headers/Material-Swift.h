...
- (BOOL)isFocusModeSupportedWithFocusMode:(AVCaptureFocusMode)focusMode SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A boolean of the result, true if supported, false otherwise.
- (BOOL)isExposureModeSupportedWithExposureMode:(AVCaptureExposureMode)exposureMode SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A boolean of the result, true if supported, false otherwise.
- (BOOL)isFlashModeSupportedWithFlashMode:(AVCaptureFlashMode)flashMode SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A boolean of the result, true if supported, false otherwise.
- (BOOL)isTorchModeSupportedWithTorchMode:(AVCaptureTorchMode)torchMode SWIFT_WARN_UNUSED_RESULT;
...
- (CGPoint)captureDevicePointOfInterestForPointWithPoint:(CGPoint)point SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A CGPoint that is converted.
- (CGPoint)pointForCaptureDevicePointOfInterestWithPoint:(CGPoint)point SWIFT_WARN_UNUSED_RESULT;
/// Prepares the view instance when intialized. When subclassing,
/// it is recommended to override the prepare method
/// to initialize property values and other setup operations.
/// The super.prepare method should always be called immediately
...
@interface MotionAnimator (SWIFT_EXTENSION(Material))
@end
...
@interface PageTabBarController (SWIFT_EXTENSION(Material))
@end
...
/// returns:
/// A PHImageRequestID.
- (PHImageRequestID)requestLivePhotoFor:(PHAsset * _Nonnull)asset targetSize:(CGSize)targetSize contentMode:(PHImageContentMode)contentMode options:(PHLivePhotoRequestOptions * _Nullable)options completion:(void (^ _Nonnull)(PHLivePhoto * _Nullable, NSDictionary * _Nullable))completion SWIFT_AVAILABILITY(ios,introduced=9.1);
/// For playback only.
...
/// An initializer that accepts a <code>from</code> and <code>to</code> Int value.
/// \param from An Int.
///
/// \param to An Int.
///
