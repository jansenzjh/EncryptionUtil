...
class IAPTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let doneButton = UIBarButtonItem(title: "Done",
                                            style: .plain,
                                            target: self,
                                            action: #selector(IAPTableViewController.DoneTapped(_:)))
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        if identifier == showDetailSegueIdentifier {
            ...
            return ProjectProducts.store.isProductPurchased(product.productIdentifier)
        }
    ...
    func reload() {
        ...
        ProjectProducts.store.requestProducts{success, products in
            if success {
    ...
    func restoreTapped(_ sender: AnyObject) {
        ProjectProducts.store.restorePurchases()
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.buyButtonHandler = { product in
            ProjectProducts.store.buyProduct(product)
        }
